...
class Spotlight(item_strategy.Strategy):
    test_cases = [
        TestCase("use button to zoom in & zoom out", "zoom_in_out_button.json"),
        TestCase("use fingers to zoom in & zoom out", "zoom_in_out_fingers.json"),
        TestCase("Transparency dark and light", "transparency.json"),
        TestCase("drag to move the spotlight", "move.json"),
    ]
